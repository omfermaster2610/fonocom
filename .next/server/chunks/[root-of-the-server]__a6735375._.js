...
"[project]/.next-internal/server/app/api/progreso/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dotenv$2f$lib$2f$main$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].config(); // Siempre primero
;
console.log("🟡 Verificando conexión a la base de datos...");
console.log("DATABASE_URL:", process.env.DATABASE_URL || "❌ No definida");
const db = new __TURBOPACK__imported__module__$5b$externals$5d2f$pg__$5b$external$5d$__$28$pg$2c$__esm_import$29$__["Pool"]({
...
"[project]/src/usuarios/usuarioService.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function obtenerUsuario(username) {
    const resUsuario = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query('SELECT * FROM usuarios WHERE username = $1', [
        username
    ]);
...
async function registrarUsuario({ username, password }) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query(`INSERT INTO usuarios (username, password) VALUES ($1, $2) RETURNING id, username`, [
        username,
        password
    ]);
...
"[project]/src/app/api/progreso/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/usuarios/usuarioService.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
async function GET(request) {
    try {
        ...
        const usuario = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["obtenerUsuario"])(username);
        if (!usuario) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const progreso = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["obtenerProgreso"])(usuario.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        const progresoActual = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["obtenerProgreso"])(usuario.id);
        const progresoModuloActual = progresoActual[modulo] || 0;
        const nuevoProgreso = Math.min(progresoModuloActual + incremento, 100);
        progresoActual[modulo] = nuevoProgreso;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$usuarios$2f$usuarioService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["actualizarProgreso"])(usuario.id, progresoActual);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            username,
            modulo,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a6735375._.js.map