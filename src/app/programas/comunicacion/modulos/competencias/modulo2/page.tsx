            ...
            style={{
                ...
                <br></br>
                      <div className="p-6 space-y-6 flex">
                        ...
                        <p className="text-2xl font-bold">Competencias comunicativas comunicativas: Módulo 2</p>
                    </div>
                    <br/>
                    <p className="text-2xl font-bold">Competencia paralingüística</p>
                <br></br>
                <div className="p-6 space-y-6 flex">
                    <Swiper
                        modules={[Navigation]}
                    ...
                    >
                        ...
                        <SwiperSlide>
                            ...
                            <div className="flex justify-end ml-4 mb-4">
                                <Link href="../../../../../actividades/comunicacion/competencias/modulo2">
