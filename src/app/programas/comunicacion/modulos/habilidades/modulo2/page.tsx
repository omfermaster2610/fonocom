            ...
            style={{
                ...
                <br></br>
                      <div className="p-6 space-y-6 flex">
                        ...
                        <p className="text-2xl font-bold">Habilidades comunicativas: Módulo 2</p>
                    </div>
                    <br/>
                    <p className="text-2xl font-bold">Habla</p>
                <br></br>
                <div className="p-6 space-y-6 flex">
                    <Swiper
                        modules={[Navigation]}
                    ...
                    >
                        <SwiperSlide>
                            ...
                            <p>
                                Esta actividad busca desarrollar y mejorar la articulación, fluidez y claridad del lenguaje oral. 
                        ...
                        <SwiperSlide>
                            ...
                            <div className="flex justify-end ml-4 mb-4">
                                <Link href="../../../../../actividades/comunicacion/habilidades/modulo2">
