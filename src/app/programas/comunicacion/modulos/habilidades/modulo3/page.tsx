            ...
            style={{
                ...
                <br></br>
                      <div className="p-6 space-y-6 flex">
                        ...
                        <p className="text-2xl font-bold">Habilidades comunicativas: Modulo 3</p>
                    </div>
                <br></br>
                <p className="text-2xl font-bold">Habilidades de lecto-escritura</p>
                <div className="p-6 space-y-6 flex">
                    <Swiper
                        modules={[Navigation]}
                        navigation
                    ...
                    >
                        ...
                        <SwiperSlide>
                            ...
                            <div className="flex justify-end ml-4 mb-4">
                                <Link href="../../../../../actividades/comunicacion/habilidades/modulo3">
