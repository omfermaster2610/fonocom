            ...
            style={{
                ...
                <br></br>
                      <div className="p-6 space-y-6 flex">
                        ...
                        <p className="text-2xl font-bold">Empleo y trabajo: Módulo 1</p>
                    </div>
                    <br/>
                    <p className="text-2xl font-bold">Evaluación de habilidades laborales</p>                    
                <br></br>
                <div className="p-6 space-y-6 flex">
                    <Swiper
                        modules={[Navigation]}
                    ...
                    >
                        ...
                        <SwiperSlide>
                            ...
                            <div className="flex justify-end ml-4 mb-4 gap-6">
                                <Link href="../../../../../actividades/empleo/modulo1">
